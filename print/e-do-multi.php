...
$querymulti = mysqli_query($conn,"SELECT * from delivery_order where no_master_blawb='$_GET[no_master_blawb]'");
while ($datamulti = mysqli_fetch_assoc($querymulti)) {
	...
	$datado = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * from delivery_order where nomor_do='$datamulti[nomor_do]'"));
	$html = '
	<br>
